//! \example get-chessboard-pose.cpp
#include <iostream>
...
int main(int argc, const char ** argv) {
  int chessboard_width = 8, chessboard_height = 6;
  double chessboard_square_size = 0.025;
  ...
  if (!intrinsic_file.empty() && !camera_name.empty()) {
    ...
    std::cout << "parse camera parameter\n";
  }
#endif
  /*--------------------------------modify the cam parameter here --------------------------------------*/
